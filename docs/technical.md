...
Implementation notes, reproducible benchmarks, measurements, and the reasoning
behind the CUDA Image Pipeline. All shell commands assume the repository root.

[Build](#build-run-test) · [Gallery](#gallery) · [Architecture](#architecture) ·
[Filters](#filter-status) · [Configuration](#configure-the-pipeline) ·
[Performance](#performance-and-methodology) · [Run benchmarks](#reproduce-the-benchmarks) ·
[Tests](#correctness-and-test-coverage) · [Future exploration](#completed-milestones-and-future-exploration)
...
<table>
  ...
  <tr>
    ...
    <td><img src="images/kodim01-grayscale.png" alt="Building after CUDA grayscale conversion" width="420"></td>
  </tr>
...
<table>
  ...
  <tr><th align="center">Before</th><th align="center">After</th></tr>
  <tr>
    <td><img src="images/gaussian-detail-before.png" alt="Original brick detail enlarged four times" width="420"></td>
    <td><img src="images/gaussian-detail-after.png" alt="Brick detail after one 3x3 Gaussian blur pass" width="420"></td>
  </tr>
...
<table>
  ...
  <tr>
    ...
    <td><img src="images/kodim01-sobel.png" alt="Sobel output highlighting building edges" width="420"></td>
  </tr>
...
<table>
  ...
  <tr><th align="center">Before</th><th align="center">After</th></tr>
  <tr>
    <td><img src="images/stars-original.png" alt="Original star field" width="420"></td>
    <td><img src="images/stars-heart-bokeh.png" alt="Star field with additive heart-shaped highlights" width="420"></td>
  </tr>
...
[Full blur input](../assets/kodim01.png) · [Full blur output](images/kodim01-gaussian-blur.png).
<table>
  <tr><th colspan="2">Sharpen (strength 1)</th></tr>
  <tr><th>Before</th><th>After</th></tr>
  <tr>
    <td><img src="../assets/kodim01.png" alt="Original building image" width="420"></td>
    <td><img src="images/kodim01-sharpen.png" alt="Building image after sharpening" width="420"></td>
  </tr>
</table>
...
see the [recorded output](pipeline-benchmark-results.txt). Device allocations
...
Raw results: [Lena](sharpen-benchmark-lena.txt),
[Kodak image](sharpen-benchmark-kodim01.txt).
